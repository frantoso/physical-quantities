...
class TemperatureTest {
    ...
    fun `test initialisation`() {
        ...
        assertThat(temperature.kelvin).isEqualTo(280.toRawType())
    }
    ...
    fun `test initialisation from literal (°C)`() {
        ...
        assertThat(temperature.kelvin).isCloseTo(290.15.toRawType(), STANDARD_OFFSET)
    }
    ...
    fun `test initialisation from literal (Celsius)`() {
        ...
        assertThat(temperature.kelvin).isCloseTo(300.15.toRawType(), STANDARD_OFFSET)
    }
    ...
    fun `test createFromValue`() {
        ...
        assertThat(temperature.kelvin).isEqualTo((-24).toRawType())
    }
    ...
    fun `to value with unit (Celsius)`() {
        ...
        assertThat(result.value).isCloseTo(46.85.toRawType(), STANDARD_OFFSET)
